      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="avatars/1.png" style="width:35px;height:35px;" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="avatars/1.png" class="user-image" alt="User Image">
              <span class="hidden-xs"><?=admin_name_connected()?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="avatars/1.png"  class="img-circle" alt="User Image">
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="./?p=manejar_tracking">
            <i class="fa fa-th"></i> <span>Ver comprobantes de pago</span>
          </a>
        </li>
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="avatars/1.png" style="width:35px;height:35px;" alt="user image" class="offline">
